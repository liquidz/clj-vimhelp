...
demo: .vim-iced
	...
	clojure -m vimhelp.core \
		...
		--style "body { font-family: 'Roboto Mono', monospace; } p { margin: 0; } .section-header .section-link { visibility: hidden; margin-left: -1.5rem; padding-right: 0.5rem; } .section-header:hover .section-link { visibility: visible; }" \
